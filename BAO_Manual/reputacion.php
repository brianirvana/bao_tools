...
<tr>
<td>
<table class="titulo_seccion"><tr><td><a name="ver"></a>- Reputación y Estados -</td></tr></table><br><table width="98%" align="center"><tr><td><span class="size">En el mundo de Bender Online imperan ciertas leyes, por ejemplo existen estados por los cuales se deduce nuestra reputación, los cuales podrás ver al clickear en el <span class="resaltarcmd">BOTÓN ESTADÍSTICAS</span>. Los puntos de reputación son bandido, ladrón, burgués, asesino, noble y plebe; según nuestro comportamiento los mismos suben o bajan una cantidad de puntos X.
</span>
<br><br><br>
...
-Resucitar un usuario ciudadano: +500 puntos nobleza.<br>
-Matar una criatura hostil: +500 puntos nobleza.<br>
...
-Matar una mascota propia(sólo si eres criminal): +500 puntos nobleza.<br>
...
-Plebe se gana usando herramientas de trabajo (talar, pescar, etc.), cada uso da: +2 puntos plebe.<br>
-Burgués NO habilitado.<br>
-Usuario ciudadano ataca a un ciudadano: +100 puntos bandido y baja a la mitad los puntos de nobleza y plebe.<br>
-Usuario ciudadano mata a un ciudadano: +2000 puntos asesino y baja a 0 los puntos de nobleza y plebe.

<br>
-Atacar la criatura que otro ciudadano está atacando.<br><br><br><br>
...
-Robándole a algún usuario.<br>
-Atacando criaturas no hostiles.<br>
-Atacando mascotas propias o de usuarios Ciudadanos.
<br>
...
-Subiendo puntos de cualquiera de los estados positivos (Nobleza y Plebe) hasta que éste sea mayor a la suma de los puntos negativos. (Ladrón, Asesino y Bandido)<br>
-Dejarse matar por un Guardia Imperial o Sacerdote Imperial: -100 puntos bandido o -50 puntos ladrón.<br>
-NO hay forma de disminuir los puntos de asesino así que tengan cuidado...</td></tr></table><br><br><table class="titulo_seccion"><tr><td>---</td></tr></table><table class="volver_indice"><tr valign="middle"><td align="left">&nbsp;<a href="index.php">&lt;&lt;Ir al Índice del Manual</a></td><td align="right">&nbsp;</td></tr></table>
