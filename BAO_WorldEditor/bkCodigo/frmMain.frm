...
Begin VB.Form frmMain 
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":7174
      mode            =   1
      value           =   0
      customclick     =   1
      image           =   "frmMain.frx":71A0
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":7522
      mode            =   1
      value           =   0
      image           =   "frmMain.frx":7546
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      cgradient       =   8421631
      cfore           =   0
      font            =   "frmMain.frx":ABA8
      mode            =   1
      value           =   0
      image           =   "frmMain.frx":ABCC
      imgsize         =   24
      imgalign        =   5
      cfhover         =   0
      cback           =   -2147483633
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":20896
         Left            =   1080
         List            =   "frmMain.frx":208A6
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":208B6
         Left            =   120
         List            =   "frmMain.frx":208B8
         Sorted          =   -1  'True
         TabIndex        =   71
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":20926
         Left            =   3360
         List            =   "frmMain.frx":20928
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":2092A
         Left            =   840
         List            =   "frmMain.frx":2092C
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":2092E
         Left            =   120
         List            =   "frmMain.frx":20930
         TabIndex        =   66
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":20932
         Left            =   840
         List            =   "frmMain.frx":20934
         TabIndex        =   58
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":20936
         Left            =   3360
         List            =   "frmMain.frx":20938
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":2093A
         Left            =   120
         List            =   "frmMain.frx":2093C
         TabIndex        =   55
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":2093E
         Left            =   120
         List            =   "frmMain.frx":20940
         TabIndex        =   54
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":20B5E
         Left            =   840
         List            =   "frmMain.frx":20B60
         TabIndex        =   77
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":20B62
         Left            =   120
         List            =   "frmMain.frx":20B64
         TabIndex        =   79
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":20B66
         Left            =   3360
         List            =   "frmMain.frx":20B68
         TabIndex        =   80
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":20B8E
      mode            =   1
      value           =   0
      customclick     =   1
      image           =   "frmMain.frx":20BB2
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If Shift = vbCtrlMask Then
        If Seleccionando Then
            ...
            If KeyCode = vbKeyI Then PegarSeleccionInvertida
        End If
    End If
