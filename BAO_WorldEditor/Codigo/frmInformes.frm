...
ActalizarObjetos_Error:
    ...
    Call LogError("Error " & err.Number & " (" & err.Description & ") en procedimiento ActalizarObjetos de Formulario frmInformes línea: " & Erl())
...
ActalizarNPCs_Error:
    ...
    Call LogError("Error " & err.Number & " (" & err.Description & ") en procedimiento ActalizarNPCs de Formulario frmInformes línea: " & Erl())
...
80                    txtInfo.Text = txtInfo.Text & vbCrLf & X & "," & Y & " nos traslada a la posición " & MapData(X, Y).TileExit.X & "," & MapData(X, Y).TileExit.Y & " del Mapa " & MapData(X, Y).TileExit.Map
...
ActalizarTranslados_Error:
    ...
    Call LogError("Error " & err.Number & " (" & err.Description & ") en procedimiento ActalizarTranslados de Formulario frmInformes línea: " & Erl())
