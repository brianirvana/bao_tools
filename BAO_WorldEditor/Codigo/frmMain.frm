...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraOpciones 
      ...
      Begin WorldEditor.lvButtons_H LvBOpcion 
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":6F04
         mode            =   0
         value           =   0   'False
         image           =   "frmMain.frx":6F2C
         cback           =   -2147483633
      End
      Begin WorldEditor.lvButtons_H LvBOpcion 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":7B7E
         mode            =   0
         value           =   0   'False
         image           =   "frmMain.frx":7BA6
         cback           =   -2147483633
      End
      Begin WorldEditor.lvButtons_H LvBOpcion 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":87F8
         mode            =   0
         value           =   0   'False
         image           =   "frmMain.frx":8820
         cback           =   -2147483633
      End
      Begin WorldEditor.lvButtons_H LvBOpcion 
         Height          =   375
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   1
      cgradient       =   8421631
      font            =   "frmMain.frx":A0CA
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":A0EE
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":A6B4
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":A6D8
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":ABDA
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":ABFE
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":AFB4
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":AFE0
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":B362
      mode            =   1
      value           =   0   'False
      image           =   "frmMain.frx":B386
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      cgradient       =   8421631
      cfore           =   0
      font            =   "frmMain.frx":E9E8
      mode            =   1
      value           =   0   'False
      image           =   "frmMain.frx":EA0C
      imgsize         =   24
      imgalign        =   5
      cfhover         =   0
      cback           =   -2147483633
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":246D6
         Left            =   1080
         List            =   "frmMain.frx":246E6
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":246F6
         Left            =   120
         List            =   "frmMain.frx":246F8
         Sorted          =   -1  'True
         TabIndex        =   71
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":24766
         Left            =   3360
         List            =   "frmMain.frx":24768
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":2476A
         Left            =   840
         List            =   "frmMain.frx":2476C
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":2476E
         Left            =   120
         List            =   "frmMain.frx":24770
         TabIndex        =   66
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":24772
         Left            =   840
         List            =   "frmMain.frx":24774
         TabIndex        =   58
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":24776
         Left            =   3360
         List            =   "frmMain.frx":24778
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":2477A
         Left            =   120
         List            =   "frmMain.frx":2477C
         TabIndex        =   55
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":2477E
         Left            =   120
         List            =   "frmMain.frx":24780
         TabIndex        =   54
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":2499E
         Left            =   840
         List            =   "frmMain.frx":249A0
         TabIndex        =   77
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":249A2
         Left            =   120
         List            =   "frmMain.frx":249A4
         TabIndex        =   79
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":249A6
         Left            =   3360
         List            =   "frmMain.frx":249A8
         TabIndex        =   80
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":249CE
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":249F2
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
...
10  On Error GoTo ObtenerNombreArchivo_Error

20  With Dialog

30      .Filter = "Mapas de BenderAO (*.map)|*.map"

40      If Guardar Then
50          .DialogTitle = "Guardar"
60          .DefaultExt = ".txt"
70          .FileName = vbNullString
80          .flags = cdlOFNPathMustExist
90          .ShowSave
100     Else
110         .DialogTitle = "Cargar"
120         .FileName = vbNullString
130         .flags = cdlOFNFileMustExist
140         .CancelError = False
150         .ShowOpen
160     End If
...
200 Call LogError("Error " & err.Number & " (" & err.Description & ") en procedimiento ObtenerNombreArchivo de Formulario frmMain línea: " & Erl())
End Sub
